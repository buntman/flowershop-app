...
<title>Login</title>
    ...
    <body>
        ...
        <div class="card">
        <form method="POST">
        <h1 class="d-flex justify-content-center align-items-center my-5">Login</h1>
        ...
        <div class="d-flex justify-content-center align-items-center mt-5">
            <button type="submit" class="btn btn-primary btn-lg" name="login" value="login">Submit</button>
        </div>
        <div class="p-4">
                    <p>
